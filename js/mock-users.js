...
(function initializeMockUsers() {
    // Check if users already exist to prevent overwriting changes (deletions/edits)
    const existingUsers = localStorage.getItem('users');
    if (existingUsers) {
        console.log('ℹ️ Users already found in localStorage. Skipping re-initialization.');
        return;
    }
